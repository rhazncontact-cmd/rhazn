      ...
      {user && (
        <View style={styles.card}>
          ...
          <View style={styles.actions}>
            <ActionBtn label="+1 ACSET" onPress={() => refill(1, 0)} disabled={working} />
            <ActionBtn label="+250 TAN" onPress={() => refill(0, 250)} disabled={working} />
            <ActionBtn label="-250 TAN" danger onPress={() => refill(0, -250)} disabled={working} />
          </View>

          <View style={styles.actions}>
            <StatusBtn label="ACTIVER" color={COLORS.green} onPress={() => setStatus("active")} />
            <StatusBtn label="PAUSE" color={COLORS.orange} onPress={() => setStatus("paused")} />
...
function ActionBtn({ label, onPress, danger, disabled }: any) {
  return (
    <Pressable
      disabled={disabled}
      onPress={onPress}
...
function StatusBtn({ label, onPress, color }: any) {
  return (
...
const styles = StyleSheet.create({
  ...
  title: { color: COLORS.text, fontSize: 28, fontWeight: "900", marginBottom: 20 },
  ...
  email: { color: COLORS.gold, fontWeight: "900", marginBottom: 14 },
  ...
  btnText: { color: COLORS.gold, fontWeight: "800" },
  statusBtn: {
    paddingVertical: 12,
    paddingHorizontal: 14,
    borderRadius: 12,
