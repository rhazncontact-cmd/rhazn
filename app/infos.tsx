...
📱 RHAZN — INFOS • APPLE-LIKE DARK PREMIUM
   ...
   Accessible depuis les tabs de publication :
   KoseSans / Audio / Vidéo → redirigent ici
================================================================ */
...
// ─────────────────────────────────────────────────────────────
// PALETTE — cohérente avec publish/suspentz & publish/products
// ─────────────────────────────────────────────────────────────
const C = {
  bg:        "#000000",
  card:      "#0E0E0E",
...
// ─────────────────────────────────────────────────────────────
// NAV TABS (identiques aux autres pages publish)
// ─────────────────────────────────────────────────────────────
const NAV_TABS = [
...
const SECTIONS = [
  {
    ...
    badgeText: "#000",
    description:
      "KoseSans est l'espace d'expression textuelle de RHAZN. Publiez des articles, des réflexions profondes, des conseils pratiques ou des analyses — sans limite de format.",
    features: [
  ...
  },
  {
    ...
    badgeText: "#FFF",
    description:
      "Podcasts, conférences, méditations, musique — RHAZN Audio vous offre une plateforme dédiée à la création sonore. Touchez vos auditeurs là où les mots seuls ne suffisent pas.",
    features: [
  ...
  },
  {
    ...
    badgeText: "#000",
    description:
      "Documentaires, tutoriels, vlogs, films courts — RHAZN Vidéo est la plateforme pour les créateurs qui veulent aller au-delà du format court de Suspentz.",
    features: [
...
export default function InfosScreen() {
  ...
  /* ── ACSET (identique à publish/suspentz & publish/products) ── */
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: C.bg }}>
      ...
      {/* ════════ HEADER FIXE FLOTTANT (position absolute — identique suspentz/products) ════════ */}
      <View style={s.floatingHeader}>
        ...
        <View style={s.headerRow}>
          ...
          {/* ✅ Badge ACSET — identique publish/suspentz */}
        ...
        {/* Ligne 2 : Tabs navigation scrollables */}
        <ScrollView
          horizontal
          ...
          {NAV_TABS.map((tab) => {
            ...
            return (
              <Pressable
                ...
                onPress={() => {
                  if (tab.label !== "KoseSans" && tab.label !== "Audio" && tab.label !== "Vidéo") {
      ...
      >
        ...
        <View style={s.ctaCard}>
          ...
          <Pressable
            ...
            onPress={() => router.push("/publish/suspentz")}
          >
          ...
          <Pressable
            ...
            onPress={() => router.push("/publish/products")}
          >
        ...
        <View style={s.footer}>
          <Text style={s.footerTxt}>
            RHAZN • Plateforme de création premium
          </Text>
...
const s = StyleSheet.create({
  ...
  /* ── Header fixe flottant — identique publish/suspentz & publish/products ── */
  floatingHeader: {
    position: "absolute",
    top: 42,
    left: 0,
  ...
  /* ✅ Nav tabs — identique publish/suspentz */
  ...
  /* ✅ Pills — identique publish/suspentz */
  ...
  ctaCard: {
    margin: 16, marginTop: 4,
    backgroundColor: C.card, borderRadius: 22,
    padding: 20, borderWidth: 1, borderColor: C.goldBorder,
  },
...
/* ── Section card sub-styles (séparés pour éviter le conflit de nommage) ── */
